...
///    can be used:
///    - SF_FIRST: Ony the first seed vector is tried.
///    - SF_EACH: All seed vectors are tried until a subspace is found.
///    - SF_MAKE: All vectors in the subspace generated by the seed vectors are tried (more
///         precisely, a representant of each on-dimensionsl subspace of the seed space).
///         The seed vector are expected to be linearly independent. However, this is not verified.
